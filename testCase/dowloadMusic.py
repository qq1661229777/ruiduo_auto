'''
@Author: your name
@Date: 2019-11-12 18:42:03
@LastEditTime: 2019-11-21 16:23:02
@LastEditors: Please set LastEditors
@Description: In User Settings Edit
@FilePath: \REEAD_UI\testCase\dowloadMusic.py
'''
import time
#导入浏览器driver类
...
#导入界面元素类
#导入主界面元素
import pageElement.dome_homePage as home_Page
#导入日志模块类
...
class dowloadMusic(appDriver, unittest.TestCase):
